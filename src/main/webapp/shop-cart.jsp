...
<head>
<meta charset="utf-8">
<title>MyECommerceSite | My Cart</title>
<!-- Imports -->
...
<body>
	<main class="page-wrapper">
		...
		<div class="container pb-5 mb-2 mb-md-4">
			<div class="row">
				<!-- List of items-->
				<section class="col-lg-8" id="cart-section">
					<div
						...
						<a class="btn btn-outline-primary btn-sm ps-2"
							href="shop-categories.jsp"><i class="ci-arrow-left me-2"></i>Continue
							shopping</a>
					</div>
						...
						<div
							...
							<div
								...
								<a class="d-inline-block flex-shrink-0 mx-auto me-sm-4"
									href="product-view.jsp"><img src="img/shop/cart/04.jpg"
							...
							<div
								...
								<label class="form-label" for="quantity4">Quantity</label> <input
									class="form-control" type="number" id="quantity4" min="1"
									value="1">
					...
					<button class="btn btn-outline-primary d-block w-100 mt-4"
						type="button" id="update-cart">
				...
				<aside class="col-lg-4 pt-4 pt-lg-0 ps-xl-5"
					id="cart-total-checkout-area">
					<div class="bg-white rounded-3 shadow-lg p-4">
						<div class="py-2 px-xl-2">
							<div class="text-center mb-4 pb-3 border-bottom">
								<h2 class="h6 mb-3 pb-1">Subtotal</h2>
								<h3 class="fw-normal" id="cart-total-container"></h3>
							</div>
							<a class="btn btn-primary btn-shadow d-block w-100 mt-4"
								href="<%if(session.getAttribute("uid")!=null){ %>checkout-details.jsp<%}else{ %>account-signin.jsp?checkout=true<% }%>"><i
