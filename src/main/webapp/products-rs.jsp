					...
					<div
						...
						<div class="d-flex flex-wrap">
							<div
								...
								<label
									...
									id="sorting" name="sorting" onchange="filterProductsGrid()">
						...
						<div class="d-none d-sm-flex pb-3">
							<a
								...
								href="products-list-rs.jsp?cid=<%=category_id%>"><i
									...
									<li
										...
										<div class="form-check">
											<input class="form-check-input" name="brands[]"
												onchange="filterProductsGrid()" type="checkbox"
									...
									<li
										...
										<div class="form-check">
											<input class="form-check-input"
												onchange="filterProductsGrid()" name="filterVariations[]"
